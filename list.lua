...
t.case_table = {
	[1] = {
		category = "raid",
		level = 2,
		description = "[watchlist]: Leaves raids when his SR doesn't drop, pattern found of at least 3 raids.",
	...
	[2] = {
		category = "raid",
		level = 2,
		description = "[watchlist]: Left raid after less than 30 minutes right after his SR was gone.",
	...
	[3] = {
		category = "dungeon",
		level = 2,
		description = "[watchlist]: Ninja'd all the items at the end of a run and didn't reply to someone asking them back.",
	...
	[4] = {
		category = "raid",
		level = 3,
		description = "Didn't give item to a winner of the roll despite all the raid telling him to do so. Also rolled for both specs as MS.",
	...
	[5] = {
		category = "raid",
		level = 2,
		description = "[watchlist]: Leaves raids after SR is gone or at the first wipe, pattern found of leaving with multiple chars a lot of times.",
	...
	[6] = {
		category = "dungeon",
		level = 2,
		description = "[watchlist]: Ninja'd all items at the end of the run and left, refused to give them back.",
	...
	[7] = {
		category = "harassment",
		level = 3,
		description = "Insults everyone, shouts in voice, ninjapulls and leaves the raid. Overall toxic player.",
