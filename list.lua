...
t.case_table = {
	[1] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Ninja'd an item that was SR and equipped it instantly. Claimed it was a mistake and tried to compensate.",
		url = "https://discord.com/channels/610036506974748700/1130985731016364032",
		name = "Mirisa",
		class = "PRIEST",
		faction = "Horde",
		guid = "Player-4465-0308FF19",
	},
	[2] = {
		category = "raid",
		level = 3,
	...
	[27] = {
		category = "harassment",
		level = 2,
		description = "[scambuster]: Harassed a player that didn't do anything, defamating in trade chat. Also griefed in Yogg spawning clouds on purpose.",
	...
	[30] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ninja'd an item. Does LC in PUGs, guild approves the LC and defends it, doubled down in report.",
	...
	[53] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Gets RL and proceeds to kick parts of the raid without warning, not answering when asked why, bricking their entire id",
	...
	[54] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Forming a group for Ulduar 25, taking no responsibility as the RL and leaving after getting everyone locked to FL.",
		url = "https://discord.com/channels/610036506974748700/1113028990551195709",
		name = "Thundrmaster",
		class = "SHAMAN",
		faction = "Horde",
	...
	[63] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ignored first 2 rolls and gave it to 3rd as RL. Said the item was not good for them but it was incorrect. Is learning to handle it better.",
	...
	[64] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd a tank neck while being a rogue, didn't reply to players asking for it back.",
	...
	[97] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Received ninja'd item from RL and equipped it instantly. Seems to be learning and new to the game.",
	...
	[106] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Took 500g and accepted player into a raid for it, then kicked the player after they needed on something that was not HR, no gold back.",
	...
	[144] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Player left raid after Algalon after forcing the raid to go to that boss despite all raid agreeing to continue on the other bosses after.",
	...
	[149] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Deleted all the SR on a player because the player changed SR when they shouldn't have and tried to correct it after.",
		url = "https://discord.com/channels/610036506974748700/1095344757460439241",
		name = "Ebonhate",
		class = "DEATHKNIGHT",
		faction = "Horde",
	...
	[153] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Player left raid after losing roll for Fragments of Val'anyr mid-run.",
	...
	[170] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd a fist weapon with a class that cannot use it.",
	...
	[176] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ninja'd tier legs rolling for them as MS when they had MS ones already. Has been lowered to watchlist for good behavior.",
	...
	[177] = {
		category = "harassment",
		level = 2,
		description = "[scambuster]: Homophobic slurs and harassing player from multiple different chars relogging to continue the harassment,",
	...
	[178] = {
		category = "harassment",
		level = 2,
		description = "[scambuster]: Homophobic slurs and harassment with multiple characters relogging to keep it going on.",
		url = "https://discord.com/channels/610036506974748700/1087106371503263914",
		name = "Nosoywickked",
		class = "WARRIOR",
		faction = "Horde",
	...
	[179] = {
		category = "harassment",
		level = 2,
		description = "[scambuster]: Homophobic insults and IRL threats with several characters relogging to keep the harassment going on.",
		url = "https://discord.com/channels/610036506974748700/1087106371503263914",
		name = "Wickkardo",
		class = "DRUID",
		faction = "Horde",
	...
	[184] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ignored a player's SR and gave the item directly to the other person that had it without rolling the item.",
	...
	[211] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Gave mount from OS to the wrong person re-rolling it a second time and ignoring the raid.",
		url = "https://discord.com/channels/610036506974748700/1079162165782655087",
		name = "Seminence",
		class = "PALADIN",
		faction = "Horde",
	...
	[213] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Took DPS tier in VoA as tank from DPS warrior, lied about deleting them when actually he used and enchanted them.",
	...
	[227] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Ninja'd [Breastplate of the Lost Conqueror] after losing the roll and being wrongly awarded it then refused to trade the rightful winner.",
	...
	[237] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Needed on items worse than currently equipped during HC+ to DE",
	...
	[259] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: needed on multiple items, winning and taking sword, which the player cannot use and the tank needed.",
	...
	[271] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ninja'd [Mantle of Dissemination] via loot pooling after they rolled low their friend Kuboom rolled and traded it to them.",
	...
	[272] = {
		category = "raid",
		level = 2,
		description = "[scambuster]: Ninja'd [Mantle of Dissemination] via loot pooling to trade it to their friend Solarys who rolled low.",
		url = "https://discord.com/channels/610036506974748700/1061769678516662296",
		name = "Kuboom",
		class = "DRUID",
		faction = "Horde",
	...
	[275] = {
		category = "dungeon",
		level = 2,
		description = "[scambuster]: Ninja'd [Mark of the War Prisoner] by turning on master looter and preventing anyone else rolling on it.",
	...
	[283] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd [Royal Crest of Lordaeron] and other items, confirming in chat their intention to vendor them.",
	...
	[288] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd [Flamebeard's Bracers] (healing bracers) and many other items at the end of a Azjol Nerub run then instantly logged out.",
	...
	[296] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd [Storming Vortex Bracers] for disenchant without rolling out the shard.",
	...
	[297] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Guild <Excuses> made a group attempt to ninja [Gored Hide Legguards] by all rolling, already had better legs and should not of rolled.",
	...
	[298] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Ninja'd [Spark of Life] as a Death Knight for a shaman friend who was DPS spec'd in the run when the healer needed it.",
	...
	[378] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Gave [Hailstorm] to his rogue friend who lost the roll then they both went offline.",
		url = "https://discord.com/channels/610036506974748700/1036289689885364245",
		name = "Frenetiq",
		faction = "Horde",
	...
	[442] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Tanked a HoS HC then needed on healer trinket to give to his dps friend leaving the healer empty handed.",
		url = "https://discord.com/channels/610036506974748700/1032578654489813002",
		name = "Bârt",
		class = "SHAMAN",
		faction = "Horde",
	...
	[449] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Took item with RL from highest roller in 25 man",
	...
	[454] = {
		category = "dungeon",
		level = 3,
		description = "[scambuster]: Admitted needing on epic plate gear to DE for themselves.",
		url = "https://discord.com/channels/610036506974748700/1043854693358645388",
		name = "Eilthyra",
		faction = "Horde",
