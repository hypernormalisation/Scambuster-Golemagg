...
t.case_table = {
	[1] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Ninja'd an item being second roll, didn't give it to correct winner and said it should be for him because of a personal opinion.",
	...
	[2] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Does loot council in raids, not allowing MS rolls from certain players based on personal opinions. Gave item to second roll.",
		url = "https://discord.com/channels/610036506974748700/1165661620425478176",
		name = "Pupecnisnura",
		class = "DRUID",
		faction = "Horde",
	...
	[3] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Rolled MS for a BoE item only to put it in the AH right away, when other people needed it for use.",
