...
t.case_table = {
	...
	[3] = {
		category = "raid",
		level = 3,
		description = "[scambuster]: Ninja'd items that were SRed by players. Gave back one (and asked back for it again), didn't give the second one back.",
		url = "https://discord.com/channels/610036506974748700/1146511283080929372",
		players = {
			[1] = {
				name = "Nocturnalw",
				class = "SHAMAN",
